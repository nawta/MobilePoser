...
class RecordingPathProvider:
    ...
    @property
    def mps_path(self) -> Optional[MpsDataPathsProvider]:
...
class RecordingDataProvider(RecordingPathProvider):
    ...
    @property
    def vrs_dp(self) -> Optional[VrsDataProvider]:
        return self._vrs_dp

    @property
    def mps_dp(self) -> Optional[MpsDataProvider]:
        return self._mps_dp
...
def create_recording_data_provider(
    recording_path: Path,
) -> Optional[RecordingDataProvider]:
